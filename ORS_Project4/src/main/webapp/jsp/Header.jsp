 ...
 %></td>
		...
		<tr>
			...
			<td colspan="2"><font style="font-size: 18px"> <a
				...
				%>  <%-- <a href="<%=ORSView.VENDORS_CTL%>">Add VENDORS</b></a> 
				|  --%>
				...
				<%-- 	
			 	  <a
					href="<%=ORSView.PAYMENT_CTL%>">Add Payment</a> | 
					<a
					href="<%=ORSView.PAYMENT_LIST_CTL%>">Payment list</a> |
					 <a
					href="<%=ORSView.BANK_CTL%>">Add Bank</a> | <a
					href="<%=ORSView.BANK_LIST_CTL%>">Bank List</a> | 
					 --%>
					 <a
				  ...
				  <a
					href="<%=ORSView.PRODUCT_CTL%>">Add product</b></a> | 
					<a
					href="<%=ORSView.PRODUCT_LIST_CTL%>"> Product List</b></a> |
					 <%--  <a
					href="<%=ORSView.ORDER_CTL%>"> Add Order</b></a> |
					 <a
