	...
	<form action="<%=ORSView.PRODUCT_LIST_CTL%>" method="post">
		...
		<center>
			...
			<table width="100%" align="center">
				...
				<th></th>
				<th></th>
					<td align="center"><label>Category</font> :
					</label> <input type="text" name="category"
				...
				<%-- 	<td align="center"><label>Description</font> :
					...
					<td align="center"><label>ProductPrice</font> :
					...
					<td align="center"><label>ProductName</font> :
						...
						&emsp; <label>Product Date</font> :
					</label> <%=HTMLUtility.getList("rlist", String.valueOf(bean.getPurchaseDate()),rlist)%>
