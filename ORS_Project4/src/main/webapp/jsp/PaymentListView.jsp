		...
		<center>
			...
			<table width="100%" align="center">
				...
				<label>Bank Name</font> :
					</label> <%=HTMLUtility.getList("rlist", String.valueOf(bean.getBank()),rlist)%>


					<th></th>
					<td align="center"><label>Payer Name</font> :
					</label> <input type="text" name="name" placeholder="Enter Payer Name"
						value="<%=ServletUtility.getParameter("name", request)%>">
						&emsp; <input type="submit" name="operation"
						value="<%=PaymentListCtl.OP_SEARCH%>"> &nbsp; <input
						type="submit" name="operation"
						value="<%=PaymentListCtl.OP_RESET%>"></td>
				</tr>
			</table>
			<br>
